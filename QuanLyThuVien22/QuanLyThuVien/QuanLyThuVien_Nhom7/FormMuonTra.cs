...
namespace QuanLyThuVien_Nhom7
{
    public partial class FormMuonTra : Form
    {
        ...
        private void dataGTTMuon_CellClick(object sender, DataGridViewCellEventArgs e)
        {
           
        }

        private void dataGTTMuon_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
